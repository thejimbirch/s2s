...
`/components/sales/icons/_icons.twig`.
...
```
{% include "@sales/icons/_icons.twig" with {
  icon_name: 'menu',
} %}
```
...
```
<svg class="main-nav__toggle main-nav__toggle--active">
  <use xmlns:xlink="http://www.w3.org/1999/xlink"
  xlink:href="/icons.svg#src--menu"></use>
</svg>
```
<Preview>
  <Story id="sales-icons--icons" />
</Preview>
